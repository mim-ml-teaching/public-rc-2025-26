...
from .models import OdometryMeasurement, Point2D, Pose1D, Pose2D, SensorMeasurement
...
class SLAMFrontend:
    ...
    def generate_measurements(self) -> None:
        ...
        self.odometry_measurements = [
            ...
            OdometryMeasurement(
                step_index=i, delta_x=delta_x, delta_y=0.0, delta_theta=0.0
            )
...
class SLAM2DFrontend:
    ...
    def generate_ground_truth(self) -> None:
        ...
        # Generate trajectory based on specified shape and num_steps parameter
